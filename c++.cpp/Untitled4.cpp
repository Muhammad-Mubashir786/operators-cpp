    ...
    do {
        ...
        if (room_choice == 'A' || room_choice == 'a') {
            ...
            if (time_choice >= 1 && time_choice <= 3) {
                process_booking(roomA_slots[time_choice - 1], roomA_names[time_choice - 1], "Room A", (time_choice == 1) ? "04:00 pm To 06:00 pm" : (time_choice == 2) ? "06:00 pm To 08:00 pm" : "08:00 pm To 10:00 pm");
            } else {
            ...
            if (time_choice >= 1 && time_choice <= 3) {
                process_booking(roomB_slots[time_choice - 1], roomB_names[time_choice - 1], "Room B", (time_choice == 1) ? "04:00 pm To 06:00 pm" : (time_choice == 2) ? "06:00 pm To 08:00 pm" : "08:00 pm To 10:00 pm");
            } else {
                cout << "Invalid Time Slot! Please try again.\n";
                valid_input = false;
            }
